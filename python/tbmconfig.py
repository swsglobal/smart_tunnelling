...
tbm1.shieldLength=12.05+1.2 #aumentato a 1.2 il gap tra scudo e testa, prima era 1.
tbm1.frontShieldLength=4.82+1.2 #1.815+1 #4.82+1.
tbm1.frontShieldDiameter=10.60
tbm1.tailShieldDiameter=10.42
tbm1.excavationDiameter=10.66 #0.90 di conicità
...
tbm10.excavationDiameter=10.56 # Nord; 10.51 per la sud; #0.6 conicità
tbm10.frontShieldDiameter=10.44
tbm10.tailShieldDiameter=10.32
tbm10.overcut=0. # fino a .12
tbm10.shieldLength=1.+11.7 #11.2+1.
tbm10.frontShieldLength=1.+4.85 #2.42+1 #4.7+1.
...
tbm10.referenceRpm=1.5 #2.2 #relativo alla massima Cutterhead Torque #0-5.3
tbm10.nominalTorque=29837 #18083. #Cutterhead Torque
tbm10.breakawayTorque=44756 #27125. #Exceptional Cutterhead Torque; in low speed ho 40687
tbm10.weight=1300.*9.81
# QUESTI DATI NON CI SONO NELLE SPECIFICHE:
tbm10.cutterThickness=0.02
tbm10.backupDragForce=8000.
tbm10.openingRatio=0.113
...
tbm51.cutterheadThickness=0.8 #1. # spessore della testa di scavo in metri
tbm51.loadPerCutter=315.
tbm51.cutterSize=19.*0.0254 #diameter
tbm51.cutterSpacing=0.09
tbm51.cutterCount=39
tbm51.totalContactThrust=12000
tbm51.cutterThickness=0.02
tbm51.referenceRpm=3 #MANCA IL DATO! prima  usato 4.5 (non reference, è valore medio del range I)
tbm51.nominalTorque=10500.
tbm51.breakawayTorque=11800.
# QUESTI DATI NON CI SONO NELLE SPECIFICHE:
tbm51.weight=1300.*9.81
tbm51.backupDragForce=8000.
tbm51.openingRatio=0.07
...
tbm23.frontShieldLength=5.3 + 1. #2.35+1 #4.3+1.
tbm23.tailShieldDiameter=6.56
tbm23.excavationDiameter=6.76
